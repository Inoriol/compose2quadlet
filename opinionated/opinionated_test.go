...
func TestApplyNetworkAliases(t *testing.T) {
	...
	sec := result[0].Sections[0]
	assertDirectiveValue(t, sec, "NetworkAlias", "backend")
	assertDirectiveValue(t, sec, "NetworkAlias", "frontend")
}
...
func TestApplySELinux_Mount(t *testing.T) {
	...
	result := ApplySELinux(units, cfg)
	sec := result[0].Sections[0]
	assertDirectiveValue(t, sec, "Mount", "type=bind,source=/data,destination=/data,selinux=z")
}
...
func TestApplyPortOffset(t *testing.T) {
	...
	sec := result[0].Sections[0]
	assertDirectiveValue(t, sec, "PublishPort", "18080:80")
	assertDirectiveValue(t, sec, "PublishPort", "192.168.1.1:18080:80")
}
...
func TestApplyPortOffset_WithProtocol(t *testing.T) {
	...
	result := ApplyPortOffset(units, cfg)
	sec := result[0].Sections[0]
	assertDirectiveValue(t, sec, "PublishPort", "18080:80/udp")
...
func TestApply_FullPipeline(t *testing.T) {
	...
	assertDirectiveValue(t, containerSec, "NetworkAlias", "cq-myapp-backend")
	assertDirectiveValue(t, containerSec, "PublishPort", "18080:80")
